...
class Matrice_oarecare: public Matrice{
    ...
    {     
     ...
     const Complex get_element(int i, int j)            //functie const
    {
        return v[i][j] ;
    }
...
class Matrice_patratica: public Matrice{
    ...
    const Complex get_element(int i, int j)
    {
        return v[i][j] ;
    }
     ~Matrice_patratica()
...
template <class T> class Inversa_Matrice 
{
    private:
    
     int lin_inv, col_inv;            //daca nu merge, aici trb sa te uiti
    Complex **v_inv;
    public:
   Inversa_Matrice(int dim, T A)
   {
        lin_inv=dim;
        col_inv=dim;
        this ->v_inv=new Complex *[lin_inv];
        for (int i = 0; i < lin_inv; i++)
             this->v_inv[i] = new Complex[col_inv];

        // for (int i=0; i<lin_inv; i++)
        // {
        //     for (int j=0; j<col_inv; j++)
        //         cout<<v_inv[i][j]<<" ";
        //     cout<<endl;
        // }
   ...
   for(int i =0; i<lin_inv; i++)
    ...
    Inversa_Matrice(int lin, int col, T A)
   {
        lin_inv=col;
        col_inv=lin;
        this ->v_inv=new Complex *[lin_inv];
 ...
 template<class T> void RTTI (T *A){
    if(dynamic_cast<Matrice_oarecare*>(A))
         cout<<"Matricea este oarecare";
    else cout<<"Matricea este patratica";
}
...
int main()
{
    ...
    {   cout<<"------MATRICI COMPLEXE------"<<endl<<endl;
        ...
        cout<<"10.Afisarea transpusei unei matrici patratice"<<endl;
        cout<<"11.Afisarea transpusei unei matrici oarecare"<<endl;
        cout<<"12.Citire n matrici de oricare fel"<<endl;
        cout<<"13.Iesiti din program"<<endl;
        ...
        else if(optiune==10)
        {
            ...
            try{
                if(dim10<1)
                  throw 12;
            Matrice_patratica OP10(dim10);
            cin>>OP10;
            Inversa_Matrice<Matrice_patratica> OPI10(dim10, OP10);
            ...
            try{
                ...
                if(lin11 == col11)
                  throw 13;
            Matrice_oarecare OP11(lin11,col11);
            cin>>OP11;
            Inversa_Matrice<Matrice_oarecare> OPI11(lin11,col11, OP11);
        ...
        while(optiune_n!=7)
        {
            ...
            cout<<"6.Afiseaza tipul unei matrici cu un index dat"<<endl;
            cout<<"7.Iesiti din subprogram"<<endl;
            cout<<"Alegeti optiunea:";
            cin>>optiune_n;
            if(optiune_n==1)
            {
            ...
            else if(optiune_n==6)
            {
              ...
              cout<<"indexul este:";
              cin>>index_7;
              RTTI<Matrice>(Matrice_diverse[index_7]);
              cout<<endl;
            }
